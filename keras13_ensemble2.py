...
model.fit([x1_train,x2_train], [y1_train,y2_train,y3_train], 
          epochs=100, batch_size = 1, validation_data = ([x1_val,x2_val],[y1_val,y2_val,y3_val])) 
...
predict_bbb = model.predict([x1_pred,x2_pred], batch_size = 1)
print(predict_bbb)
