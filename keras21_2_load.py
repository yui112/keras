...
model = load_model('./save/save_test01.h5', compile=False)


model2.add(Dense(10, name='home1'))
model2.add(Dense(2, name='home2'))
model2.add(Dense(3, name='home3'))
model2.add(Dense(1, name='home4')) # output 개수
...
model2.fit(x_train, y_train, epochs=100, batch_size=1,
          validation_data=(x_val,y_val), 
          callbacks = [early_stopping, tb_hist])

#4. 평가
loss, mse = model2.evaluate(x_test, y_test,batch_size=1)
print('mse : ', mse)
